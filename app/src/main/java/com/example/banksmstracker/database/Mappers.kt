...
fun List<CategoryWithMerchants>.toDomainCategories(): List<Category> =
    map { categoryWithMerchants ->
        Category(
...
fun List<SenderWithDetails>.toDomainSenders(): List<Sender> =
    map { senderWithDetails ->
        Sender(
